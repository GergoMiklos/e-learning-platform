...
export default function NewTaskSearchElementComp({task, isSelected, selectedLevel, onSelectLevel, levels, onAddTask}) {
                        ...
                        {task.answers.map(
                            (answer, i) =>
                                <div key={answer.number}
                                     className={(answer.number === task.solutionNumber) ?
