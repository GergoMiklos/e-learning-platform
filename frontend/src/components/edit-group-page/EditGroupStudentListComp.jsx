...
export default function EditGroupStudentListComp({students, addUserCode, onAddUserCodeChange, onAddStudent, groupId}) {
        ...
        <div>
            ...
            <div className="row my-3">
                <ul className="col-12 list-group">
                    {students?.length === 0 ? "No Students" : students.map(user =>
                        <li
