...
public interface UserTestStatusRepository extends Neo4jRepository<UserTestStatus, Long> {
    ...
    List<UserTestStatus> findByDeprecatedIsFalseAndTestIdIs(Long testId, @Depth int depth);

    List<UserTestStatus> findByDeprecatedIsFalseAndUserIdIs(Long testId, @Depth int depth);
