...
public class DefaultUserService implements UserService {
    ...
    @Override public List<User> getStudentsForGroup(Long groupId) {
        return userRepository.findByStudentGroupsIdOrderByName(groupId, 1);
    }

    @Override public List<User> getTeachersForGroup(Long groupId) {
        return userRepository.findByTeacherGroupsIdOrderByName(groupId, 1);
    }

    @Override public List<User> getStudentsForParent(Long parentId) {
